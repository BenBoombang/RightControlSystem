...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/update"
				...
				<%-- 隐藏域，存储产品ID --%>
				<input type="hidden" id="hiddenProductId" name="id" value="${product.id}">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="产品描述"
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#productStatus option[value='"+ ${product.productStatus} +"']").attr("selected", true);
